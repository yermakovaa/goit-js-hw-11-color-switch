...
function addBgColor() {
  refs.body.style.cssText = "background-color: ".concat(newColor());
}

function newColor() {
  var idxColor = randomIntegerFromInterval(0, colors.length - 1);
...
require("./js/colors");
},{"./sass/main.scss":"sass/main.scss","./js/colors":"js/colors.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
